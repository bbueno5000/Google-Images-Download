    ...
    if object_check['config_file'] != '':
        ...
        parser.add_argument(
            ...
            choices=[
                ...
                'Norwegian', 'Portuguese', 'Polish', 'Romanian', 'Russian', 'Spanish', 'Swedish', 'Turkish'])
        parser.add_argument(
            '-pr', '--prefix', default=False,
...
class GoogleImagesDownload:
    ...
    def build_search_url(self, search_term, params, url, similar_images, specific_site, safe_search):
        ...
        if url:
            ...
            url = 'https://www.google.com/search?q=' + urllib.parse.quote(search_term.encode(
                'utf-8')) + '&espv=2&biw=1366&bih=667&site=webhp&source=lnms&tbm=isch' + \
                    params + '&sa=X&ei=XosDVaCXD8TasATItgE&ved=0CAcQ_AUoAg'
        # safe search check
        if safe_search:
    ...
    def download_executor(self, arguments):
        ...
        total_errors = 0
        for pky in prefix_keywords: # for every prefix keywords
            for sky in suffix_keywords: # for every suffix keywords
                i = 0
                while i < len(search_keyword): # for every main keyword
                    ...
                    if limit < 101:
                        ...
                        images, tabs = self.download_page_extended(url, arguments['chromedriver'])
                    if not arguments["silent_mode"]:
                    ...
                    if arguments['related_images']:
                        ...
                        for key, value in tabs.items():
                            ...
                            if limit < 101:
                                ...
                                images, _ = self.download_page_extended(value, arguments['chromedriver'])
    ...
    def download_page(self, url):
        ...
        try:
            ...
            print(
                ...
                'Please leave a comment with the above error at: '
                'https://github.com/hardikvasa/google-images-download/pull/298')
            sys.exit()

    def download_page_extended(self, url, chromedriver):
        """
...
class Main:
    ...
    def main():
        ...
        TODO: docstring
        """
        records = [{"keywords":"Polar bears,baloons,Beaches","limit":20,"print_urls":True}]
        #records = user_input()
        total_errors = 0
